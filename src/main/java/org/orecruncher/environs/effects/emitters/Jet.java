...
public abstract class Jet extends ParticleEmitter {
	...
	public Jet(final int strength, final BlockGetter world, final double x, final double y, final double z) {
		this(0, strength, world, x, y, z, 3);
	}

	public Jet(final int layer, final int strength, final BlockGetter world, final double x, final double y,
